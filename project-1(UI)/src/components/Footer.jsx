...
const Footer = () => {
  return (
    <footer className="bg-gray-100 mt-6">
      <div
        className="text-gray-500 text-xs space-y-3 items-center py-5 grid px4
md:px-64"
      >
        <p>
          ◊Instant cashback is available with the purchase of an{" "}
          <a href="#" className="underline text-gray-500 font-semibold">
            eligible product
          </a>{" "}
        ...
        <p>
          ...
          <a href="T#" className="underline text-gray-500 fontsemibold"></a>{" "}
          Terms apply.
        </p>
        <p>
      ...
      <hr className=" w-11/12 md:w-4/6 mx-auto border-t border-gray-300 my4"></hr>
      <div id="under" className=" py-2">
        <div className="container mx-auto flex hidden md:flex justify-center max-w6xl px-16 text-gray-700 text-xs ">
      ...
      <div className="space-y-2 md:hidden">
        <div className="flex justify-between items-center px-5 font-light text-sm">
          <p>Shop and Learn</p>
          <FaAngleDown />
        </div>
        <hr className="mx-5 border-gray-400"></hr>
        <div className="flex justify-between items-center px-5 font-light text-sm">
          <p>Apple Wallet</p>
          <FaAngleDown />
        </div>
...
font-semibold"
          ...
          near you.Or call{" "}
          <a href="" className="textblue-500 underline font-semibold">
            {" "}
            000800 040 1966.
          </a>
        </p>
      </div>
      <hr className=" hidden md:block md:w-4/6 mx-auto border-t border-gray-300 my4"></hr>
      <div
        className=" relative block md:flex justify-between px-4 md:px-64 text-gray500
text-xs py-8 md:py-4 space-y-2 items-center"
      >
        <h2>Copyright © 2025 Apple Inc. All rights reserved.</h2>
        <ul className=" flex items-center justify-center md:mr-72 font-semibold gap-2 flexwrap">
          <li>
        ...
        <p
          className="absolute top-2 p md:relative md:top-0 fontsemibold
"
        >
          india
        </p>
